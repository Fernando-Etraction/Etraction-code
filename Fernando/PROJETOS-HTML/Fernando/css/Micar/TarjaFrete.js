(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = `
        ...
        .step:first-child {
            ...
            padding-left: 20px;
            background: linear-gradient(135deg, #1A6292 0%, #1A6292 45%, #1A6292 100%);
            color: white;
        }
        ...
        .step:last-child {
            ...
            background: linear-gradient(135deg, #1A6292 0%, #1A6292 50%, #1A6292 100%);
            color: white;
        }
  ...
  function insertBlock() {
    var target = document.getElementById('gallery-image-and-product-options');

    if (!target) {
      log('❌ target #gallery-image-and-product-options não encontrado');
      return false;
    }
    ...
    log('✅ bloco inserido após #gallery-image-and-product-options');
    return true;
  }
